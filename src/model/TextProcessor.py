...
from structures.gramatic import Gramatic
from structures.regular_expression import RegularExpression
from structures.transducer import Transcuder
import re
...
class TextProcessor:
    ...
    def grammarProcessor(self,text):
        newText= text.lower()
        return self.gr.checkGramatic(newText.split())
